...
## 2026-04-25 - Destructive Action Confirmation
**Learning:** Users can accidentally delete tasks or configurations without a warning.
**Action:** Always wrap destructive UI actions like deletions in a confirmation dialog (e.g., `window.confirm`) to prevent accidental data loss and adhere to the project's UX standards.
