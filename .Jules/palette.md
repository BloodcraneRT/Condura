...
## 2024-05-21 - Destructive Actions UX
**Learning:** Implementing destructive UI actions (such as deleting tasks or configurations) without user confirmation leads to accidental data loss and poor user experience.
**Action:** When implementing destructive UI actions, always wrap the action in a confirmation dialog (e.g., `window.confirm`) to prevent accidental data loss and adhere to the project's UX standards.
