...
## 2026-04-29 - Destructive Action Confirmations
**Learning:** Destructive actions (like deleting a task) executing immediately without confirmation can lead to accidental data loss and frustration.
**Action:** Always wrap destructive API calls with a confirmation dialog (e.g., `window.confirm`) before executing to give users a chance to abort the action.
