...
## 2026-04-18 - Destructive Action Confirmation
**Learning:** Accidental task deletion can occur when the delete action triggers immediately upon click, causing frustration.
**Action:** Always wrap destructive actions like deletion in a confirmation dialog (e.g., `window.confirm`) to prevent accidental data loss and reduce user anxiety.
