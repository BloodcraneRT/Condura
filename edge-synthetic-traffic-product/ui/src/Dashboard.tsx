        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white shadow-md border border-gray-100 rounded-3xl p-8 transition-shadow duration-300">
            ...
            <form onSubmit={handleCreateTask} className="space-y-6">
              ...
              <div>
                <label htmlFor="source-target" className="block text-sm font-semibold text-gray-700 mb-2">Source Target <span className="text-red-500" aria-hidden="true">*</span></label>
                <select
                  id="source-target"
                  className="block w-full border-gray-200 bg-white py-3 px-4 focus:outline-none focus:ring-2 focus:ring-rose-500 focus:border-rose-500 sm:text-sm rounded-xl border shadow-sm transition-shadow"
              ...
              <button type="submit" disabled={isCreatingTask} className="w-full mt-4 justify-center py-3.5 px-4 text-sm font-bold rounded-xl text-white bg-gradient-to-r from-rose-500 to-rose-600 hover:from-rose-600 hover:to-rose-700 shadow-md hover:shadow-lg transition-all focus:ring-2 focus:ring-offset-2 focus:ring-rose-500 disabled:opacity-70 disabled:cursor-not-allowed">
                {isCreatingTask ? "Running..." : "Run Task"}
              </button>
            </form>
          </div>
          ...
          <div className="bg-white shadow-md border border-gray-100 rounded-3xl p-8 transition-shadow duration-300">
            ...
            <form onSubmit={handleCreateSource} className="space-y-6">
              <div>
                <label htmlFor="source-name" className="block text-sm font-semibold text-gray-700 mb-2">Name <span className="text-red-500" aria-hidden="true">*</span></label>
                <input
                  id="source-name"
                  type="text"
                  required
              ...
              <div>
                <label htmlFor="source-target-url" className="block text-sm font-semibold text-gray-700 mb-2">Target URL or IP <span className="text-red-500" aria-hidden="true">*</span></label>
                <input
              ...
              <button type="submit" disabled={isCreatingSource} className="w-full mt-4 justify-center py-3.5 px-4 text-sm font-bold rounded-xl text-gray-700 bg-white border-2 border-gray-200 hover:border-gray-300 hover:bg-gray-50 shadow-sm transition-all disabled:opacity-70 disabled:cursor-not-allowed">
