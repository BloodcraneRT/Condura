        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white shadow-md border border-gray-100 rounded-3xl p-8 transition-shadow duration-300">
            ...
            <form onSubmit={handleCreateTask} className="space-y-6">
              <div>
                <label htmlFor="test-type" className="block text-sm font-semibold text-gray-700 mb-2">Test Type<span aria-hidden="true" className="text-rose-500 ml-1">*</span></label>
                <select
                  id="test-type"
              ...
              <button
                ...
                className={`w-full mt-4 justify-center py-3.5 px-4 text-sm font-bold rounded-xl text-white shadow-md transition-all focus:ring-2 focus:ring-offset-2 focus:ring-rose-500 ${isScheduling ? 'bg-rose-400 cursor-not-allowed opacity-70' : 'bg-gradient-to-r from-rose-500 to-rose-600 hover:from-rose-600 hover:to-rose-700 hover:shadow-lg'}`}
              >
          ...
          <div className="bg-white shadow-md border border-gray-100 rounded-3xl p-8 transition-shadow duration-300">
            ...
            <form onSubmit={handleCreateSource} className="space-y-6">
              ...
              <button
                ...
                className={`w-full mt-4 justify-center py-3.5 px-4 text-sm font-bold rounded-xl text-gray-700 bg-white border-2 border-gray-200 transition-all ${isSavingTarget ? 'opacity-70 cursor-not-allowed' : 'hover:border-gray-300 hover:bg-gray-50 shadow-sm'}`}
              >
