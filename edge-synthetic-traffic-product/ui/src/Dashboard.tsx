...
export const Dashboard: React.FC = () => {
  ...
  const handleCreateTask = (e: React.FormEvent) => {
    ...
    fetch(`${API_URL}/ui/tasks`, {
      ...
      .finally(() => setIsTaskSubmitting(false));
  };
  ...
  const handleCreateSource = (e: React.FormEvent) => {
    ...
    fetch(`${API_URL}/ui/sources`, {
      ...
      .finally(() => setIsSourceSubmitting(false));
  };
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <form onSubmit={handleCreateTask} className="space-y-6">
              ...
              <div>
                <label htmlFor="source-target" className="block text-sm font-semibold text-gray-700 mb-2">
                  Source Target <span className="text-rose-500 ml-1" aria-hidden="true">*</span>
                </label>
                <select
                  id="source-target"
                  className="block w-full border-gray-200 bg-white py-3 px-4 focus:outline-none focus:ring-2 focus:ring-rose-500 focus:border-rose-500 sm:text-sm rounded-xl border shadow-sm transition-shadow"
          ...
          <div className="bg-white shadow-md border border-gray-100 rounded-3xl p-8 transition-shadow duration-300">
            ...
            <form onSubmit={handleCreateSource} className="space-y-6">
              ...
              <button type="submit" disabled={isSourceSubmitting} className={`w-full mt-4 justify-center py-3.5 px-4 text-sm font-bold rounded-xl text-gray-700 bg-white border-2 border-gray-200 hover:border-gray-300 hover:bg-gray-50 shadow-sm transition-all disabled:opacity-70 disabled:cursor-not-allowed disabled:hover:bg-white disabled:hover:border-gray-200`}>
                {isSourceSubmitting ? 'Saving...' : 'Save Target'}
              </button>
            </form>
          </div>
        </div>
