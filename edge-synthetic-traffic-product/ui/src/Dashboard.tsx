        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white shadow-md border border-gray-100 rounded-3xl p-8 transition-shadow duration-300">
            ...
            <form onSubmit={handleCreateSource} className="space-y-6">
              ...
              <div>
                <label htmlFor="sourceTargetUrl" className="block text-sm font-semibold text-gray-700 mb-2">Target URL or IP</label>
                <input
                  id="sourceTargetUrl"
                  type="text"
                  required
                ...
                tasks.map(task => (
                  <li key={task.id} className="px-8 py-6 hover:bg-gray-50 transition-colors flex justify-between items-center group">
                    ...
                    <button
                      ...
                      className="opacity-0 group-hover:opacity-100 focus-visible:opacity-100 focus-visible:ring-2 focus-visible:ring-red-500 focus:outline-none px-4 py-2 bg-red-50 text-red-600 text-xs font-bold rounded-xl hover:bg-red-100 transition-all"
                    >
                      Delete
                    </button>
                  </li>
