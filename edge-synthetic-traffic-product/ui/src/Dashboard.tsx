        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white shadow-md border border-gray-100 rounded-3xl p-8 transition-shadow duration-300">
            ...
            <form onSubmit={handleCreateTask} className="space-y-6">
              ...
              <div>
                <label htmlFor="sourceTarget" className="block text-sm font-semibold text-gray-700 mb-2">
                  Source Target <span className="text-rose-500">*</span>
                </label>
                <select
                  id="sourceTarget"
                  className="block w-full border-gray-200 bg-white py-3 px-4 focus:outline-none focus:ring-2 focus:ring-rose-500 focus:border-rose-500 sm:text-sm rounded-xl border shadow-sm transition-shadow"
          ...
          <div className="bg-white shadow-md border border-gray-100 rounded-3xl p-8 transition-shadow duration-300">
            ...
            <form onSubmit={handleCreateSource} className="space-y-6">
              <div>
                <label htmlFor="sourceName" className="block text-sm font-semibold text-gray-700 mb-2">
              ...
              <div>
                <label htmlFor="targetUrl" className="block text-sm font-semibold text-gray-700 mb-2">
                  Target URL or IP <span className="text-rose-500">*</span>
                </label>
                <input
                  id="targetUrl"
                  type="text"
                ...
                tasks.map(task => (
                  <li key={task.id} className="px-8 py-6 hover:bg-gray-50 transition-colors flex justify-between items-center group">
                    ...
                    <button
                      ...
                      aria-label={`Delete task for ${task.target}`}
                      className="opacity-0 group-hover:opacity-100 focus:opacity-100 focus:ring-2 focus:ring-red-500 focus:outline-none px-4 py-2 bg-red-50 text-red-600 text-xs font-bold rounded-xl hover:bg-red-100 transition-all"
                    >
                      Delete
                    </button>
                  </li>
