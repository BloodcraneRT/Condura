        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white shadow-md border border-gray-100 rounded-3xl p-8 transition-shadow duration-300">
            ...
            <form onSubmit={handleCreateTask} className="space-y-6">
              ...
              <button type="submit" disabled={isSubmittingTask} className="w-full mt-4 justify-center py-3.5 px-4 text-sm font-bold rounded-xl text-white bg-gradient-to-r from-rose-500 to-rose-600 hover:from-rose-600 hover:to-rose-700 shadow-md hover:shadow-lg transition-all focus:ring-2 focus:ring-offset-2 focus:ring-rose-500 disabled:opacity-70 disabled:cursor-not-allowed">
                {isSubmittingTask ? 'Running...' : 'Run Task'}
              </button>
            </form>
          </div>
          ...
          <div className="bg-white shadow-md border border-gray-100 rounded-3xl p-8 transition-shadow duration-300">
            ...
            <form onSubmit={handleCreateSource} className="space-y-6">
              ...
              <button type="submit" disabled={isSubmittingSource} className="w-full mt-4 justify-center py-3.5 px-4 text-sm font-bold rounded-xl text-gray-700 bg-white border-2 border-gray-200 hover:border-gray-300 hover:bg-gray-50 shadow-sm transition-all disabled:opacity-70 disabled:cursor-not-allowed">
