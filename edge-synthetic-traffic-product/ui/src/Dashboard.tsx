...
export const Dashboard: React.FC = () => {
  ...
  const handleDeleteTask = (id: string, type: string) => {
    if (!window.confirm(`Are you sure you want to delete the ${type} test?`)) {
      return;
    }
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white shadow-md border border-gray-100 rounded-3xl p-8 transition-shadow duration-300">
            ...
            <form onSubmit={handleCreateTask} className="space-y-6">
              <div>
                <label htmlFor="test-type" className="block text-sm font-semibold text-gray-700 mb-2">
                  Test Type <span aria-hidden="true" className="text-rose-500 ml-1">*</span>
                </label>
                <select
                  id="test-type"
