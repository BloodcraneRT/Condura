            ...
            <form onSubmit={handleCreateTask} className="space-y-6">
              ...
              <div>
                <label htmlFor="source-target" className="block text-sm font-semibold text-gray-700 mb-2">
                  Source Target <span aria-hidden="true" className="text-rose-500 ml-1">*</span>
                </label>
                <select
                  id="source-target"
                  className="block w-full border-gray-200 bg-white py-3 px-4 focus:outline-none focus:ring-2 focus:ring-rose-500 focus:border-rose-500 sm:text-sm rounded-xl border shadow-sm transition-shadow"
              ...
              <button type="submit" disabled={isCreatingTask} className="w-full mt-4 justify-center py-3.5 px-4 text-sm font-bold rounded-xl text-white bg-gradient-to-r from-rose-500 to-rose-600 hover:from-rose-600 hover:to-rose-700 shadow-md hover:shadow-lg transition-all focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-rose-500 disabled:opacity-50 disabled:cursor-not-allowed">
            ...
            <form onSubmit={handleCreateSource} className="space-y-6">
              <div>
                <label htmlFor="source-name" className="block text-sm font-semibold text-gray-700 mb-2">
                  Name <span aria-hidden="true" className="text-rose-500 ml-1">*</span>
                </label>
                <input
                  id="source-name"
                  type="text"
              ...
              <div>
                <label htmlFor="source-target-url" className="block text-sm font-semibold text-gray-700 mb-2">
                  Target URL or IP <span aria-hidden="true" className="text-rose-500 ml-1">*</span>
                </label>
                <input
              ...
              <button type="submit" disabled={isCreatingSource} className="w-full mt-4 justify-center py-3.5 px-4 text-sm font-bold rounded-xl text-gray-700 bg-white border-2 border-gray-200 hover:border-gray-300 hover:bg-gray-50 shadow-sm transition-all focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-gray-400 disabled:opacity-50 disabled:cursor-not-allowed">
