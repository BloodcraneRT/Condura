...
type OstinatoConfig struct {
	Protocol   string `json:"protocol"`   // "tcp" or "udp"
	PacketSize int    `json:"packetSize"` // in bytes
	PPS        int    `json:"pps"`        // packets per second
	Duration   int    `json:"duration"`   // duration of the blast in seconds
}
